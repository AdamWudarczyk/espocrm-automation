...
class AccountsPage(BasePage):
    CREATE_BUTTONS = [
        ...
        (By.CSS_SELECTOR, 'a[href*="#Account/create"], a[data-name="create"]'),
        (By.XPATH, '//a[contains(normalize-space(.), "Create Account")]'),
    ...
    MORE_TOGGLE = (
        By.XPATH,
        '//div[starts-with(@id,"account-detail-")]//button[contains(@class,"dropdown-toggle")][1]'
    )
    ...
    def edit_account_name(self, new_name: str):
    ...
    def assert_account_not_present(self, name: str):
        self.open_hash("Account")
